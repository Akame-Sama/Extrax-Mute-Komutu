module.exports = {
  ...
  $setRoles[$mentioned[1];$getServerVar[unmute]]
  $wait[$message[1]]
  ...
  Mute Süresi : \`\$message[1]\`\}{thumbnail:$userAvatar[$mentioned[1]]}]
  ...
  $onlyIf[$mentioned[1]!=;{color:$getServerVar[hex]}{thumbnail:$userAvatar}{description:$getVar[çarpı] | Lütfen Birini Etiketle}]
  $onlyIf[$message[1]!=;{color:$getServerVar[hex]}{thumbnail:$userAvatar}{description:$getVar[çarpı] | Lütfen Bir Süre Belirt
  1 Hafta : 1w
  1 Gün : 1d
  1 Saat : 1h
  1 Dakika : 1m
  ...
  $onlyIf[$hasRole[$authorID;$getServerVar[muteyetkili]]==true;{color:$getServerVar[hex]}{thumbnail:$userAvatar}{description:🎋 | Üzgünüm Ama \`\$roleName[$getServerVar[muteyetkili]]\`\ Rolün Yok}]
  `
}
